...
const FoodCard = () => {
    return (
        <div className="font-bold w-[250px] bg-white p-5 flex flex-col gap-2 rounded-lg">
            ...
            <p className="text-sm font-normal">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aperiam,
                pariatur.</p>
            <div className="flex justify-between">
                <span className="flex justify-center items-center">
                    <AiFillStar className="mr-1 text-yellow-400"/> 4.5
                </span>
                <button className="p-1 text-white bg-green-500 hover:bg-green-600 rounded-lg text-sm">Add to cart
                </button>
            </div>
        </div>
    );
